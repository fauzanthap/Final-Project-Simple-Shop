...
<hr style="width: 1370px; margin-left: -10px;" align="left"> <br><br>
   ...
   <div class="produk">
    ...
    ?>
        <table align="center">
          <tr align="center">
            <th>
              <img src="gambar/<?php echo $data['gambar_produk'] ?>" width="100" height="100">
            </th>
          </tr>
          <tr >
            <th>
              <a href="produk.php?id_produk=<?= $data['id_produk'] ?>" class="klik">
               <?= $data['nama_produk'] ?></a>
            </th>
          </tr>
          <tr > 
...
height: 30px; border-radius: 10px;">
    <a href="login.php" style="text-decoration: none;" class="icon"><svg style="width:20px;height:20px" viewBox="0 -2 24 23">
